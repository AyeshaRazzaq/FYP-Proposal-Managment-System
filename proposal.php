    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="proposal.php" class="nav-item nav-link active"><i class="bi bi-file-arrow-down-fill me-2"></i>Proposal</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <h3 class="text-primary ms-3 mt-2 text-center">Proposals</h3>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['search'])) {
                                    ...
                                    $query = "SELECT * FROM proposals WHERE CONCAT(`name`, `rollno`, `title`, `class`) LIKE '%" . $valuetosearch . "%'";
                                } else {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    $id = $row['id'];
                                    echo "<td>";
                                    echo "<a href='student/print-details.php?id=$id'>details</a>"; 
                                    echo "</td>";
