    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="profile.php" class="nav-item nav-link active"><i class="bi bi-person-circle me-2"></i>Profile</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <h3 class="text-primary ms-3 mt-2 text-center">Profile</h3>
                  ...
                  <div class="col-md-4">
                    <div class="mt-4">
                      <img class="bg-secondary rounded-circle img-fluid ms-5 " src="img/images.jpeg"
                        alt="admin image">
                      <h5 class="text-center fw-semibold text-black mt-3 mb-1">Admin</h5>
                      <p class="text-center text-primary text-decoration-underline admin-email mb-1"><?php
                            if (isset($_SESSION['user_data'])) {
                    ...
                    <table class="table sup-table">        
                      <tbody>
                        ...
                        <tr>
                          ...
                          <?php
                            if (isset($_SESSION['user_data'])) {
                                $contact = $_SESSION['user_data']['contactno'];
                                echo "$contact";
                            }
                            ?>
                          </td>
