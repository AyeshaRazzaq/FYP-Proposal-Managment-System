        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="admin-dashboard.php" class="navbar-brand mb-3">
                    <h5 class="text-primary ps-1">FYP Management System</h5>
                </a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4 mt-4">
                <div class="row g-4">
                    ...
                    if (isset($_SESSION['alert-successful'])) {
                    ?>

                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <?php echo ($_SESSION['alert-successful']) ?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php
                        unset($_SESSION['alert-successful']);
                    }
                    ?>
                    <!-- successful alert msg end -->
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-user-tie fa-2x text-primary"></i>
                            <div class="ms-3 ">
                                <a href="supervisor.php" class="mb-2 text-decoration-none" style="color: gray;">Total Supervisors</a>
                                <h6 class="mb-0">
                                    <?php
                                    $qry = mysqli_query($connection, 'SELECT COUNT(*) as counting  FROM user WHERE `role` = "supervisor" ');
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <a href="students.php" class="mb-2 text-decoration-none" style="color: gray;">Total Students</a>
                                <h6 class="mb-0">
                                    <?php
                                    $qry = mysqli_query($connection, 'SELECT COUNT(*) as counting  FROM user WHERE `role` = "student" ');
                                    $qry_execute = mysqli_fetch_assoc($qry);
                                    echo ($qry_execute['counting']);
                                    ?>
                                </h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between" style="padding: 22px;">
                            <i class="bi bi-file-arrow-down-fill fa-2x text-primary"></i>
                            <div class="ms-3">
                                <a href="proposal.php" class="mb-2 text-decoration-none" style="color: gray;">Total Proposals</a>
                                <h6 class="mb-0">
                                    <?php
                                    $qry = mysqli_query($connection, 'SELECT COUNT(*) as counting FROM proposals');
                                    $qry_execute = mysqli_fetch_assoc($qry);
                                    echo ($qry_execute['counting']);
                                    ?>
                                </h6>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between" style="padding: 22px;">
                            <i class="bi bi-file-earmark-code-fill fa-2x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Total Projects</p>
                                <h6 class="mb-0">
                                    <?php
                                    $qry = mysqli_query($connection, 'SELECT COUNT(*) as counting  FROM project ');
                                    $qry_execute = mysqli_fetch_assoc($qry);
                                    echo ($qry_execute['counting']);
