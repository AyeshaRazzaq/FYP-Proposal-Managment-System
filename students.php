    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            if (isset($_POST['submit'])) {
                ...
                $regno = $_POST['regno'];
                $role = $_POST['role'];
                $result = mysqli_query($connection, "INSERT into user('username','email','cnic','contactno','regno','role')VALUES('$name','$email','$cnic','$contactno','$regno','$role')");
            }
            ?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="mb-4 mx-4 d-flex justify-content-between align-items-center text-end">
                        ...
                        ?>
                        <!--del student session end -->

                        <!--student not delete session start -->
                        <?php
                        ...
                        ?>
                        <!--student not delete session end -->

                         <!--add student session start -->
                         <?php
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['search'])) {
                                    ...
                                    $query = "SELECT * FROM user WHERE role = 'student' AND CONCAT(`name`, `email`, `cnic`, `contactno`,`regno`) LIKE '%" . $valuetosearch . "%'";
                                } else {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>" . $row['role'] . "</td>";
                                    echo "<td>";
                                    echo "<a class='btn btn-primary btn-sm px-3' href='edit-form.php?id=" . $row['id'] . "'>Edit</a>";
                                    echo "<td>";
