    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0 ">
                ...
                <h3 class="text-center text-primary my-2 ps-2">Queries</h3>
            ...
            <div class="container-fluid pt-4 px-4 mt-3">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="response.php" class="btn btn-sm btn-primary p-2 me-4">chat</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM chat WHERE supervisor='$username'";

                                // Modify the query if search is performed
                                if (isset($_POST['search'])) {
                                    $valuetosearch = $_POST['valuetosearch'];
                                    $query = "SELECT * FROM chat WHERE role='$username' AND (name LIKE '%$valuetosearch%' OR  note LIKE '%$valuetosearch%')";
                                }
