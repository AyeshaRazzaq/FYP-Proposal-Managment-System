    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <h3 class="text-center text-primary my-2 ps-2">Schedule a meeting</h3>
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <?php
                                    ...
                                    $query = "SELECT * FROM meeting WHERE role='$username'";

                                    // Modify the query if search is performed
                                    if (isset($_POST['search'])) {
                                        $valuetosearch = $_POST['valuetosearch'];
                                        $query = "SELECT * FROM meeting WHERE role='$username' AND (name LIKE '%$valuetosearch%' OR rollno LIKE '%$valuetosearch%' OR date LIKE '%$valuetosearch%' OR time LIKE '%$valuetosearch%' OR note LIKE '%$valuetosearch%')";
                                    }
