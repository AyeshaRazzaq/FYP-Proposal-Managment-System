    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a href="proposals.php" class="nav-item nav-link"><i class="bi bi-file-earmark-medical-fill me-2"></i>pending</a>
                            ...
                            <a href="rej-proposals.php" class="nav-item nav-link active"><i class="bi bi-file-earmark-excel-fill me-2"></i>Rejected</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <h3 class="text-center text-primary my-2 ps-2">Rejected Proposals</h3>
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM proposals WHERE role = '$username' AND status='rejected'";
