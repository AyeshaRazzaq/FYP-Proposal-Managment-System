        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="meeting.php" class="nav-item nav-link active"><i class="bi bi-bell-fill me-2"></i>Meetings</a>
        ...
        <div class="content">
            ...
            <div class="container mt-5">
                <div class="form-container">
                    <form action="insert-meeting.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="rollno" name="rollno" placeholder="0000" required>
                        </div>
                        <div class="form-group">
                            <label for="role" class="fw-bold">Supervisor</label>
                            <input type="text" class="form-control" id="role" name="role" value="<?php echo "$username" ?>" placeholder="0000" required>
                        </div>
                        <div class="form-group">
                            <label for="meetingDate" class="fw-bold">Meeting Date:</label>
                            <input type="date" class="form-control" id="meetingDate" name="date" required>
                        </div>
                        <div class="form-group">
                            <label for="meetingTime" class="fw-bold">Meeting Time:</label>
                        ...
                        <button type="submit" class="btn btn-primary mt-3" name="submit">Schedule Meeting</button>
                    </form>
                </div>
            </div>
            <!-- table end -->
