...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Student project form start -->
            <div class="container-fluid pt-2 px-4">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="form-div mx-auto mb-3">
                            <form method="post" action="insert-project.php" enctype="multipart/form-data">
                                <?php
                                ...
                                <div class="col-12 mb-2">
                                    <div class="col-12 mb-2">
                                        <label for="name" class="me-2 mb-2 fw-bold">Name:</label>
                                        <input type="text" class="form-control" id="name" required placeholder="Name" name="name" required>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <label for="rollno" class="me-2 mb-2 fw-bold">Roll No</label>
                                        <input type="text" class="form-control" id="rollno" required placeholder="0000" name="rollno" required>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <label for="title" class="me-2 mb-2 fw-bold">Project Title:</label>
                                        <input type="text" class="form-control p-2" id="title" required placeholder="Project Title" name="title">
                                    </div>
                                    <div class="col-12 mb-2">
                                        <label for="supervisor" class="me-2 mb-2 fw-bold">Supervisor:</label>
                                        <select id="supervisor" class="form-select" required name="supervisor">
                                            <?php
                                            $connection = mysqli_connect("localhost", "root", '', 'mysqli_fyp');
                                ...
                                <div class="col-12 mb-2">
                                    <label for="formFile" class="form-label fw-bold">Upload File</label>
                                    <input class="form-control form-control bg-white" required id="formFile" type="file" name="uploaded_file">
                                </div>
