    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="Student-dashboard.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="stu-progress.php" class="nav-item nav-link"><i class="bi bi-graph-up me-2"></i>Progress</a>
                    <a href="stu-chat.php" class="nav-item nav-link active"><i class="bi bi-chat-dots-fill me-2"></i>Chat</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <h3 class="text-primary ms-3 mt-2 text-center">Chat</h3>
