        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="proposal-submission.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="stu-profile.php" class="nav-item nav-link active"><i class="bi bi-person-circle me-2"></i>Profile</a>
                  ...
                  <div class="col-md-4">
                    <div class="mt-4">
                      <img class="bg-secondary rounded-circle img-fluid ms-5 " src="img/images.jpeg"
                        alt="admin image">
                      <h5 class="text-center fw-semibold text-black mt-3 mb-1">
                        <!-- display username -->
                        <?php
                                if (isset($_SESSION['user_data'])) {
