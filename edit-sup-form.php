    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <h3 class="text-primary ms-3 mt-2 text-center">Edit Supervisor Data</h3>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        $sup_id = $_GET['id'];
                        $sql = "SELECT * from user WHERE id = {$sup_id}";
                        ...
                        ?>
                                ...
                                <div class="form-div mx-auto">
                                    <form method="post" action="edit-sup.php">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingText" placeholder="2020-GCUF-0000" name="delegation" value="<?php echo $row['delegation']; ?>">
                                            <label for="floatingText">Delegation</label>
                                        </div>
                                        <div class="form-floating mb-3">
